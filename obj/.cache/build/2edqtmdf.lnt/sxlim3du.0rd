...
<p sourcefile="ProcessDoku/00_Basics/MS_Content/organization-administration/workflow-FAQ.md" sourcestartlinenumber="28">Diese Thema enthält Antworten auf häufig gestellte Fragen zum Workflowsystem.</p>
...
<p sourcefile="ProcessDoku/00_Basics/MS_Content/organization-administration/workflow-FAQ.md" sourcestartlinenumber="33">Jede Benachrichtigung gilt für eine andere Arbeitsaufgabe, die Ähnlichkeit kann jedoch zu Unklarheiten führen. Wir suchen nach Wegen, dies in einer späteren Versionen zu verbessern.</p>
...
<p sourcefile="ProcessDoku/00_Basics/MS_Content/organization-administration/workflow-FAQ.md" sourcestartlinenumber="36">Derzeit gibt es eine Einschränkung der Workflowexportfunktion, durch die Workflownamen 48 Zeichen nicht überschreiten können. Das Verwenden eines Namens, der länger als 48 Zeichen ist, kann zu einem „Fehler beim Authentifizieren der Anforderung durch Server“ führen und/oder verhindern, dass eine Datei ohne Dateityp exportiert wird. Der folgende Blog-Beitrag enthält weitere Einzelheiten, <a href="https://community.dynamics.com/ax/b/elandaxdynamicsaxupgradesanddevelopment/archive/2019/04/10/workflow-export-troubleshooting" sourcefile="ProcessDoku/00_Basics/MS_Content/organization-administration/workflow-FAQ.md" sourcestartlinenumber="36">Fehlerbehebung beim Workflow-Export</a>.</p>
<h2 id="can-the-submitter-of-a-workflow-also-approve-the-workflow" sourcefile="ProcessDoku/00_Basics/MS_Content/organization-administration/workflow-FAQ.md" sourcestartlinenumber="38">Kann der Übermittler eines Workflows auch den Workflow genehmigen?</h2>
...
<h2 id="can-i-add-alerts-to-workflows-to-provide-notifications-to-users" sourcefile="ProcessDoku/00_Basics/MS_Content/organization-administration/workflow-FAQ.md" sourcestartlinenumber="41">Kann ich Warnungen zu Workflows hinzufügen, um Benachrichtigungen für Benutzer verfügbar zu machen?</h2>
<p sourcefile="ProcessDoku/00_Basics/MS_Content/organization-administration/workflow-FAQ.md" sourcestartlinenumber="42">Nachfolgend sind einige wesentliche Konzepte, um Warnungen für Workflows zu beachten, um Benachrichtigungen zu erhalten:</p>
...
<li sourcefile="ProcessDoku/00_Basics/MS_Content/organization-administration/workflow-FAQ.md" sourcestartlinenumber="47">In einer zukünftigen Aktualisierung werden wir die Aktivitätscenternachricht hinzufügen, damit Benutzer einem Workflow-Arbeitselement zugewiesen werden.</li>
</ul>
</li>
<li sourcefile="ProcessDoku/00_Basics/MS_Content/organization-administration/workflow-FAQ.md" sourcestartlinenumber="48">Benachrichtigungen Workflows hinzufügen
<ul sourcefile="ProcessDoku/00_Basics/MS_Content/organization-administration/workflow-FAQ.md" sourcestartlinenumber="49">
<li sourcefile="ProcessDoku/00_Basics/MS_Content/organization-administration/workflow-FAQ.md" sourcestartlinenumber="49">Aktivitätscenternachrichten können für bestimmte Benutzer erstellt werden, wie eine Nachricht, die von einem früheren Workflow in X++ erstellt wurden.</li>
<li sourcefile="ProcessDoku/00_Basics/MS_Content/organization-administration/workflow-FAQ.md" sourcestartlinenumber="50"><a href="https://docs.microsoft.com/dynamics365/unified-operations/dev-itpro/business-events/business-events-workflow" sourcefile="ProcessDoku/00_Basics/MS_Content/organization-administration/workflow-FAQ.md" sourcestartlinenumber="50">Workflows haben Geschäftsereignisse</a>, die der Kunde zum Auslösen von Flows verwenden könnte, haben die gesuchten Benachrichtigungen.</li>
</ul>
</li>
</ul>
<p sourcefile="ProcessDoku/00_Basics/MS_Content/organization-administration/workflow-FAQ.md" sourcestartlinenumber="52">Zusammenfassend lässt sich sagen, dass, wenn ein Benutzer nicht die richtige Benachrichtigung vom Action Center erhält, wenn ihm ein Workflow-Workitem zugewiesen wird, dann nutzen Sie <a href="https://docs.microsoft.com/dynamics365/unified-operations/dev-itpro/business-events/business-events-workflow" sourcefile="ProcessDoku/00_Basics/MS_Content/organization-administration/workflow-FAQ.md" sourcestartlinenumber="52">Workflow-Geschäftsereignisse</a> mit Microsoft Power Automate, um zusätzliche oder andere Benachrichtigungen bereitzustellen.</p>
...
<p sourcefile="ProcessDoku/00_Basics/MS_Content/organization-administration/workflow-FAQ.md" sourcestartlinenumber="55">Wenn der Workflow-Editor unter Active Directory-Verbunddiensten (AD FS) in einer aktualisierten Umgebung ausgeführt wird, kann er möglicherweise nicht gestartet werden. Wenn dies der Fall ist, stellen Sie sicher, dass die URL &quot;https://dynamicsaxworkfloweditor/&quot; der Eigenschaft <strong sourcefile="ProcessDoku/00_Basics/MS_Content/organization-administration/workflow-FAQ.md" sourcestartlinenumber="55">Microsoft Dynamics 365 for Operations Vor Ort – Workflow – Native Anwendung</strong> in den ADFS-Einstellungen hinzugefügt wird.</p>
...
<p sourcefile="ProcessDoku/00_Basics/MS_Content/organization-administration/workflow-FAQ.md" sourcestartlinenumber="58">Der Standardfeldwert für das Feld <strong sourcefile="ProcessDoku/00_Basics/MS_Content/organization-administration/workflow-FAQ.md" sourcestartlinenumber="58">Anzahl der Workflow-Items pro Batch</strong> auf der Seite <strong sourcefile="ProcessDoku/00_Basics/MS_Content/organization-administration/workflow-FAQ.md" sourcestartlinenumber="58">Workflow-Parameter</strong> ist 0. Ein Wert von 0 bewirkt, dass sich der Standardwert auf 20 Elemente pro Stapel ändert. Seien Sie bei der Anpassung dieses Wertes vorsichtig, da eine hohe Anzahl von Elementen pro Batch (&gt; 40) zu SQL-Deadlocks führen kann.</p>
...
<p sourcefile="ProcessDoku/00_Basics/MS_Content/organization-administration/workflow-FAQ.md" sourcestartlinenumber="61">Die Funktion Workflow Enhanced Error in Version 10.0.13 fügt Fehlercodes hinzu, um verschiedene Klassen von Workflowfehlern zu unterscheiden. Die gemeldeten Fehlermeldungen ähneln sich größtenteils mit geringfügigen Unterschieden, um sie zu verdeutlichen.</p>
</article>
          </div>
