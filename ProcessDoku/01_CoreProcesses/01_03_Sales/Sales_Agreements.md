...
3. On the **Action Pane > Sales agreement**.
...
13. In the **Quantity** field, enter a quantity.
...
16. Close the page.
17. On the **Action Pane > General**.
18. Click **Attached sales agreement**.
19. Expand the Fasttab section.
